...
We built VDMS and MySQL databases using the YFCC100M dataset with incremental
database sizes 100k, 500k, 1M, 5M, 10M, 50M, and 100M.
...
Note that VDMS requires more storage for metadata, shown in
