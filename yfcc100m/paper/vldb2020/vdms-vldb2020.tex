...
\vldbTitle{Using VDMS to Search 100M Images: A Piece of Cake}
...
data access by a $\sim$10x factor on this dataset most of the queries we
used for our internal use-cases, and particularly at scale,
while simplifying the process of data preparation and data access,
and providing functionalities non-existent in alternative options.
\end{abstract}
...
We want to thank our managers Nilesh Jain and Ravi Iyer for their
