...
in efficient just because we are using a tool that was design for the job.
To demonstrate this, we use the largest available public dataset (YFCC100M),
...
data access by a 10x factor in certain queries, while simplifying the process
...
We have to acknowledge Philip, Vishakha, Nilesh, and any other reviewer.
