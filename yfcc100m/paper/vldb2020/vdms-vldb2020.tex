...
The problem grows as the scale of the data that is used for analysis or training
grows. In this paper, we demonstrate how VDMS (Visual Data Management System)
can be used to simplify the data preparation process and we show how we gain
in efficiency just because we are using a tool that was design for the job.
To demonstrate this, we use one of the largest available
public dataset (YFCC100M),
...
We demonstrate how VDMS outperforms well-know and widely used tools for
data access by a $\sim$10x factor in certain queries,
while simplifying the process
of data preparation and data access, and providing functionalities non-existent
...
We would like to thank many of the people that made this project possible and
helped us through the process.
We have to acknowledge Philip and Vishakha for help in fixing PMGD bug,
Nilesh for his help/input, and any other reviewer.
