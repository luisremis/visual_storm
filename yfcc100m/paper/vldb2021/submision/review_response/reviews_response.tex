...
improvement on metadata handling better.
...
decision for chosing the operations in section 3.
...
VDMS as a webservice without adding any additional abstractions.
An example of such frontend can be found <http://coco.datasets.aperturedata.io>.
